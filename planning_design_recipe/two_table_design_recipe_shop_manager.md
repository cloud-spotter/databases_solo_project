...
| --------------------- | ------------------  |
| items                 | name, unit price, quantity
| orders                | customer name, date placed
...
(NB. I'm treating the first question as NO here so I can apply my learning so far, with a one-to-many relation between the two tables.)
